...
export class ArticleListComponent {
    articles: Article[] = [
        ...
        },
        {
            ...
            createDate: new Date('2023-04-15'),
            image: 'https://placehold.co/150x150',
            likeCount: 99,
            isPublished: true,
            categoryName: 'API',
        ...
        },
        {
            ...
            createDate: new Date('2023-03-12'),
            image: 'https://placehold.co/150x150',
            likeCount: 95,
            isPublished: true,
        ...
        },
        {
            ...
            createDate: new Date('2023-03-05'),
            image: 'https://placehold.co/150x150',
            likeCount: 45,
            isPublished: false,
        ...
        },
        {
            ...
            createDate: new Date('2022-12-01'),
            image: 'https://placehold.co/150x150',
            likeCount: 220,
            isPublished: true,
            categoryName: 'Angular',
        ...
        },
        {
            ...
            createDate: new Date('2022-09-20'),
            image: 'https://placehold.co/150x150',
            likeCount: 92,
            isPublished: true,
            categoryName: 'Angular',
        ...
        },
        {
            ...
            createDate: new Date('2022-08-12'),
            image: 'https://placehold.co/150x150',
            likeCount: 50,
            isPublished: true,
            categoryName: 'Angular',
        ...
        },
        {
            ...
            createDate: new Date('2022-07-10'),
            image: 'https://placehold.co/150x150',
            likeCount: 85,
            isPublished: false,
            categoryName: 'Web',
        ...
        },
        {
            ...
            createDate: new Date('2022-04-01'),
            image: 'https://placehold.co/150x150',
            likeCount: 60,
            isPublished: true,
            categoryName: 'Web',
